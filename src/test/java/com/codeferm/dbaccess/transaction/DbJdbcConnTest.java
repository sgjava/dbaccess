 ...
 * @since 1.0.0
 */
public final class DbJdbcConnTest extends BaseAtomikosTest {
    ...
    public void rollback() throws Exception {
        ...
        try {
            ...
            id = test.rollbackRec(new DbJdbcConn(getDataSource()), getSqlMap().
        ...
        for (int number = 1; number <= loops; number++) {
            try {
                // This should cause rollback
                id = test.rollbackRec(new DbJdbcConn(getDataSource()),
                        getSqlMap().
                        get("insert.testtable"));
            } catch (Throwable e) {
                // Verify rollback worked
